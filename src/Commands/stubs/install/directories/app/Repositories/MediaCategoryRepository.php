...
use App\Models\MediaCategory as Category;
use App\Models\MediaCategoryDescription as CategoryDescription;
...
class MediaCategoryRepository
{
     ...
     * Store
     *
     * @return \App\Models\MediaCategory id
     */
    ...
    {
        MediaCategoryDescription::truncate();
        MediaCategory::truncate();
    }
}
