			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="page-header">
						<h1>@Lang('admin::media.heading.create')</h1>
						<ul class="breadcrumb">
							...
							<li><a href="{{ route('admin.media.create') }}">@Lang('admin::media.heading.create')</a></li>
						</ul>
				...
				<div class="panel-body">
					...
					@endif
					<form method="POST" action="{{ route('admin.media.create') }}" class="form-horizontal" id="form">
	            		{{ csrf_field() }}
