			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="page-header">
						<h1>@Lang('admin::mediaCategory.heading.edit')</h1>
						<ul class="breadcrumb">
							...
							<li><a href="{{ route('admin.media.category.edit',$category->id) }}">@Lang('admin::mediaCategory.heading.edit')</a></li>
						</ul>
				...
				<div class="panel-body">
					...
					@endif
					<form method="POST" action="{{ route('admin.media.category.edit',['id'=>$category->id]) }}" class="form-horizontal" id="form">
	            		{{ csrf_field() }}
